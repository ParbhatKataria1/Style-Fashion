...
const Content = () => {
        ...
        datasets: [
            {
                ...
                backgroundColor: ["rgba(255, 99, 132, 0.2)", "rgba(54, 162, 235, 0.2)", "rgba(94, 162, 25, 0.2)"],
    ...
    async function getMenData() {
        try {
            let data = await axios.get(`${process.env.REACT_APP_BACKEND_API}/men`, {
                params: {
                    limit: 100,
                },
                method: "no-cors",
                headers: {
                    ...
                    Authorization: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2NDI2YTNjMTQxMWI4ZTYxMGVhMzJmNTciLCJpYXQiOjE2ODAyNjM5Njh9.C_59KLK7uaLeOhjmfsCx4MvAI7lDUPm_rFjqMHVospw",
                },
            });
        ...
        <Box h="100vh">
            ...
            <Flex mt="40px" justifyContent={"space-around"}>
                <Box w="750px">
                    ...
                    <Text fontWeight={"bold"}>Distribution of Items Among Various Brands</Text>
                </Box>
